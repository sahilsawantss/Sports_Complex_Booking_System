...
<div class="d-flex align-items-center justify-content-center h-100">
  ...
  <div class="d-flex h-100 justify-content-center align-items-center col-lg-7 bg-gradient-light text-dark" style=" font-family: Arial, Helvetica, sans-serif;">
      ...
      <div class="card-body">
        <form id="register-frm" action="" method="post">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
                <input type="text" name="contact" id="contact" placeholder="Enter Contact"  class="form-control form-control-sm form-control-border" maxlength="10" pattern="[0-9]*" required>
            ...
            <div class="form-group col-md-6">
                <div class="input-group">
                  ...
                  <div class="input-group-append border-bottom border-top-0 border-left-0 border-right-0">
                    <!-- for eye add fa-eye-slash to class -->
                    <span class="input-append-text text-sm"><i class="fa text-muted pass_type" data-type="password"></i></span>
                  </div>
                </div>
